          ...
          <div class="page-title-section">
            <div class="title-wrapper">
              ...
              <div class="title-content">
                ...
                <p class="page-subtitle">Journal des modifications des contrats de domiciliation</p>
              </div>
            </div>
          </div>
                  ...
                  <button class="accordion-button collapsed modern-accordion-btn" type="button"
                    ...
                    <div class="accordion-content">
                      <div class="accordion-main-info">
                        ...
                        <span class="last-modification">Dernière modif: {{ formatDateTime(group.lastModificationDate)
                          }}</span>
                      </div>
                    ...
                    <table class="table table-hover table-striped mb-0 modern-table">
                      ...
                      <tbody>
                        <tr v-for="history in group.histories" :key="history.id" class="table-row">
                          ...
                          <td>
                            <button class="action-btn delete-action" @click="onDeleteHistory(history)"
                              title="Supprimer">
  ...
  methods: {
    ...
    async onDeleteHistory(history) {
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`/domiciliation-histories/${history.id}`, {
    ...
    exportToExcel() {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "Historique Domiciliations");
    ...
    exportToPDF() {
      ...
      printWindow.document.title = "Historique des domiciliations";
      printWindow.focus();
    },
...
<html>
  <head>
    <title>Historique des domiciliations</title>
    <meta charset="UTF-8">
  ...
  <body>
    <div class="content-wrapper">
      <div class="header">
        ...
        <div class="header-content">
          <div class="title">Historique des Domiciliations</div>
    ...
    <script>
      window.onload = function() {
        document.title = "Historique des domiciliations";
      }
    <\/script>
  </body>
</html>`;
    ...
    generatePDFWithoutLogo() {
      ...
      doc.setFontSize(18);
      doc.text("Historique des domiciliations", 14, 20);
      doc.setFontSize(11);
      ...
      doc.save(`historique_domiciliations_${new Date().toISOString().split("T")[0]}.pdf`);
    },
    ...
    async fetchHistories() {
      try {
        const response = await axios.get("/domiciliation-histories", {
          headers: this.getApiHeaders(),
          params: {
        ...
        console.log("Historique des domiciliations chargé:", this.histories);
