...
<head>
  <meta charset="UTF-8">
  <title>Résiliation de Domiciliation</title>
  <style>
    html, body {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div id="pdf-container">
    ...
    <div class="pdf-content">
      ...
      {{-- Subject --}}
      <div class="subject">
        Objet : Résiliation de domiciliation.
      </div>

      {{-- Contract Body --}}
      <div class="content">
        En date du {{ $domiciliation->created_at->format('d/m/Y') }}, nous avons mis à la disposition de la société
        ...
        Donc, cette résiliation prendra effet à compter du <strong>{{ $domiciliation->date_fin->format('d/m/Y') }}</strong>.<br><br>
